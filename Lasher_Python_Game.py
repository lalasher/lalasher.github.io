...
<body>
    ...
    <py-script>
        ...
        result = Element("result").write(selection)
        ...
        def check_guess():
            ...
            if user_guess == selection:
                result.write("Good job! You guessed correctly.")
            elif user_guess > selection:
                result.write("Incorrect, go again! Your guess was too high.")
            else:
                result.write("Incorrect, go again! Your guess was too low.")
    </py-script>
</body>
</html>
